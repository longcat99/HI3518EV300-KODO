...
static void fbtft_set_addr_win(struct fbtft_par *par, 
							   int xs, int ys, 
							   int xe, int ye)
{
	/* st7789v Drives */
    ...
    {
    	case   0: xs+=51;xe+=51;ys+=40;ye+=40;
    			 break;
    	case  90: xs+=40;xe+=40;ys+=51;ye+=51;
    			 break;
    	case 180: xs+=51;xe+=51;ys+=40;ye+=40;
    			 break;
    	case 270: xs+=40;xe+=40;ys+=51;ye+=51;
    			 break;
    	default :
    			 break;
    }
